/**
 * Class representing an abstract computer
 * @author Jacob
 *
 */
public abstract class Computer 
{
	...
	//Abstract Method (SECTION 1.4)
	
	/**
	 * A method to compute the cost to benefit ratio of a given computer
	 * @param cost The cost of the computer (for when the computer's cost is not instantiated)
	 * @return The cost-benefit ratio of getting the computer
	 */
	public abstract double costBenefit(double cost);
	
	/**
	 * A method to compute the cost to benefit ratio of a computer when its cost is specified
	 * @return The cost to benefit ratio
	 */
	public abstract double costBenefit();
	
	//Override of object method (1.5)
	...
	public boolean equals(Object obj)
	{
		...
		if(this.getClass() == obj.getClass())
		{
			...
			return (manufacturer.equals(c.manufacturer) && 
					((Double) this.computePower()).equals(((Double) c.computePower())));			
		}
		return false;
	}
